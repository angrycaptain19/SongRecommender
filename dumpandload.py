...
Original file is located at
    https://colab.research.google.com/drive/1U4PzSaDDViyDe0oVwkfcvPzOk9On8oUo
"""
...
import numpy as np
import pandas as pd
#from Song_recommendation import popularity_recommender_py, item_similarity_recommender_py
...
classi = joblib.load('model_pickle')

print(classi.recommend('useridindf'))
print(classi)

collaborative = joblib.load('collaborative_recommend')

#collaborative.get_similar_items(['Use Somebody _ Kings Of Leon','Fireflies _ Charttraxx Karaoke','Hey_ Soul Sister _ Train'])

#get similar items le k k dincha -> user le yo click gare pachi k k dine aba
#user ko last 5 songs line ani recommend magne

print(collaborative.get_similar_items(['Use Somebody _ Kings Of Leon']))
